...
export const PC_NODES: Record<string, PcNode> = {
  ...
  'work-grupo': {
    ...
    date: '06/10 14:18',
    size: '22 KB',
    body: ['Relatório de grupo — Geografia', 'Clima da região. Fontes: livro e atlas da biblioteca.', 'Entrega: feita.'],
  },
  'work-leitura': {
    id: 'work-leitura',
    app: 'work',
  ...
  'dl-horarios': {
    ...
    date: '15/10 02:14',
    size: '64 KB',
    line: 'A gente já sabia que estava fechado.',
    body: [
      'Escola Estadual Francis Milton',
      'Horário de funcionamento',
      'Aulas: 07:20 — 17:40',
      'Fechamento do prédio — 22:00',
      'Após esse horário as portas externas permanecem trancadas.',
    ],
  },
  'dl-mapa': {
    id: 'dl-mapa',
...
export const WEB_PAGES: Record<string, { url: string; title: string; body: string[] } | null> = {
  ...
  '02:16': {
    ...
    body: [
      'Após as 22h o alarme é armado.',
      'Portas externas trancam por fora.',
  ...
  '02:34': {
    ...
    body: [
      ...
      'Se a porta tranca por fora, não abre pelo lado de dentro.',
      'Cópia armazenada. Sem conexão.',
    ],
  },
  '02:51': {

...
export const HALL_LOCKERS: HallLocker[] = [
  ...
  { id: 'hall-locker-3', name: 'Lívia', fullName: 'Lívia Ferreira', kind: 'livia', pin: '2103' },
  { id: 'hall-locker-4', name: 'Marcela', fullName: 'Marcela Alves', kind: 'other' },
  { id: 'hall-locker-5', name: 'Milena', fullName: 'Milena Mendes', kind: 'other' },
  { id: 'hall-locker-6', name: 'Marina', fullName: 'Marina Oliveira', kind: 'marina', pin: '2011' },
  { id: 'hall-locker-7', name: 'Mariana', fullName: 'Mariana Pinto', kind: 'other' },

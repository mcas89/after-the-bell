...
export const ROOM_SHOTS: Record<RoomId, CameraShot> = {
  ...
  bathroom: {
    position: [0.82, 1.58, 0.08],
    lookAt: [0.82, 1.18, 1.85],
    fov: 46,
    follow: { x: 0.18, y: 0.03, z: 0.16 },
    lookFollow: 0.28,
    margin: { x: 0.55, y: 0.1, z: 0.45 },
    zoomByDepth: 0.02,
    damp: 2.2,
  },
  office: {
  ...
  backyard: {
    position: [0.2, 1.85, 2.4],
    lookAt: [0.12, 0.42, -2.8],
    fov: 48,
    follow: { x: 0.12, y: 0.04, z: 0.1 },
    lookFollow: 0.28,
    margin: { x: 1.4, y: 0.18, z: 1.4 },
    zoomByDepth: 0.04,
    damp: 2.1,
  },
  passage: {
